...
EVENT_KINDS = {"tool_attempt", "tool_result", "delegation_spawn", "delegation_follow_up", "delegation_summary", "child_session", "observer_health", "communication_observation"}
...
INTEGER_FIELDS = {"occurred_at_unix_ms", "deletion_generation", "attempt", "process_id", "retry_count", "cache_read_input_tokens", "cache_creation_input_tokens", "original_bytes", "original_lines", "original_tokens", "final_visible_bytes", "final_visible_lines", "final_visible_tokens", "provider_input_tokens", "provider_output_tokens", "threshold_count", "transformer_count", "denominator_numerator", "denominator_value", "bytes", "tokens", "tool_latency_ms"}
...
ENUM_FIELDS = {
    ...
    "lifecycle": EVENT_KINDS | {"completed"},
...
NAME_FIELDS = {
    ...
    "process_role", "denominator_name", "tokenizer_identity",
}
